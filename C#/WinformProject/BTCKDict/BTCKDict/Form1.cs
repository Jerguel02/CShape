...
namespace BTCKDict
{
    public partial class Form1 : Form
    {
        ...
        string newName = "hi";
        string newType = "interjection";
        string[] newExamples = { "hello there!" };
        string[] newMeanings = { "used as a greeting or to begin a telephone conversation" };
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (result != null)
            {
                txtMean.Text = string.Join(", ", newWord.Meanings);
            }
            else
            {
